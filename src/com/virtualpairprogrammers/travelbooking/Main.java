...
public class Main {
    public static void main(String[] args) {
        ...
        TrainTicket trainTicket2 = new TrainTicket(123L,"London","Edinburgh", new BigDecimal("59.00"), LocalDateTime.of(2022,9,30,16,3), LocalDateTime.of(2023,3,7,19,3), TravelClass.FIRST,3,45);
